...
public class WeatherGlobant {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * System.out.println(localidad.getCiudad());
		 * System.out.println(localidad.getPais());
		 * System.out.println(localidad.getRegion());
		 */

		// System.out.println(hoy.getSensacionTemperatura());
		// System.out.println(hoy.getDireccion());
		// System.out.println(hoy.getVelocidad());
		...
		for (int i = 0; i < listaForecast.size(); i++) {
			System.out.println(
					"Fecha: " + listaForecast.get(i).getString("day") + " " + listaForecast.get(i).getString("date"));
			...
			System.out.println("Condiciones: " + listaForecast.get(i).getString("text"));
			System.out.println("**********************");
		}
